			...
			if (messages != null) {
				for (Message msg : messages) {
					...
					if (msg.getSender().getId() == userSender.getId()) {
						...
						out.println("</div>");
						out.println("<img class='direct-chat-img' src='data:image/png;base64," + userSender.getImage()
						...
						out.println("</div>");
						out.println("<img class='direct-chat-img' src='data:image/png;base64," + userReceiver.getImage()
								+ "' alt='message user image'>");
						out.println("<div class='direct-chat-text'>");
						out.println(msg.getContent());
						out.println("</div>");
