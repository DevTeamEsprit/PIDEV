...
public class MailService {
    ...
    private static final String USER = "clyde mino";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
    private static final String PASSWORD = "9D8c7t65n"; // Must be valid password for smit0012
    private static final String FROM = "clydomino@gmail.com";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
}
